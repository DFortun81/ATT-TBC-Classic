...
local FESTIVAL_LOREMASTER_COORDS = {
	...
	{ 41.6, 25.3, THE_EXODAR },	-- TODO: Confirm this, sources say this wasn't until Wrath, but maybe 2.4.0 counts as that?
	-- #endif
};
local FESTIVAL_LOREMASTER_MAPS = {
	...
	-- #if AFTER TBC
	SHATTRATH_CITY,
	THE_EXODAR,	-- TODO: Confirm this, sources say this wasn't until Wrath, but maybe 2.4.0 counts as that?
	-- #endif
};
...
local FESTIVAL_TALESPINNER_COORDS = {
	...
	{ 69.8, 43.0, SILVERMOON_CITY },	-- TODO: Confirm this, sources say this wasn't until Wrath, but maybe 2.4.0 counts as that?
	-- #endif
};
local FESTIVAL_TALESPINNER_MAPS = {
	...
	-- #if AFTER TBC
	SHATTRATH_CITY,
	SILVERMOON_CITY,	-- TODO: Confirm this, sources say this wasn't until Wrath, but maybe 2.4.0 counts as that?
	-- #endif
};
